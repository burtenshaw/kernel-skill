...
![Custom Kernels for All](assets/meme.png)
...
- `diffusers` and `transformers` have different module hierarchies, normalization conventions, and integration patterns
- Custom kernels and `torch.compile` require custom ops to be registered. 
...
- [CUDA Kernels Skill (SKILL.md)](.claude/skills/cuda-kernels/SKILL.md)
- [LTX-Video Example](examples/ltx_video/)
- [Qwen3-8B Example](examples/qwen3_8b/)
